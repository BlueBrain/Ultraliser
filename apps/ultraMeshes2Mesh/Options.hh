...
{
    /**
     * @brief inputDirectory
     * Input directory where the meshes exist.
     */
    ...
    /**
     * @brief boundsFile
     * Use a bounds file to only voxelize a certain part of the space or even a
     * greater space. If the file is not given, the bounding box of the input
     * meshes will be used in addition to a little delta to avoid intersection.
     */
     ...
     * Sets the resolution of the volume based on the dimensions of the
     * given mesh.
     */
    bool autoResolution;
