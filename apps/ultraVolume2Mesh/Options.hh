...
struct Options
{
    ...
    /**
     * @brief isoValue
     * The iso-value where the volume will get segmented.
     */
    int64_t isoValue;

    /**
     * @brief fullRangeIsoValue
     * Use the entire range of the volume. If this option is set, the iso value
     * is ignored.
     */
     ...
     * Write the histogram of the file.
     */
    bool writeHistogram;

    /**
     * @brief zeroPaddingVoxels
     * The number of voxels that will be used to zero-pad the volume to avoid
     * any clipping artifacts in the reconstructed meshes.
     */
    int64_t zeroPaddingVoxels;
