...
/**
 * The code in this file is inspired on ideas first published in the following paper:
 * Jonathan Richard Shewchuk, Adaptive Precision Floating-Point Arithmetic and Fast Robust
 * Geometric Predicates, Discrete & Computational Geometry.
 */
...
/**
 * @brief initPredicates
 * Sets  the variables used for exact arithmetic.
 * This function must be called once before using the other two functions.
 */
void initPredicates()
{
    static char a_c=0;
