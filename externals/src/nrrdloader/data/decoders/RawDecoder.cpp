...
{
public:
    static size_t inBytes(libNRRD::NRRDType type)
    {
        switch (type)
        {
...
{
public:
    static std::unique_ptr<libNRRD::IDataMangler> parseAndBuild(
        const libNRRD::NRRDHeader &header,
        std::string_view input)
    {
        bool isLittleEndian = header.endian == libNRRD::NRRDEndianness::Little;
